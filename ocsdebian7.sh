...
wget -O /etc/nginx/nginx.conf "https://raw.github.com/thirdza056/ocspanel/master/nginx.conf"
wget -O /etc/nginx/conf.d/vps.conf "https://raw.github.com/thirdza056/ocspanel/master/vps.conf"
